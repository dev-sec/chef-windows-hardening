...
include_recipe 'windows-hardening::account_lockout'
...
include_recipe 'windows-hardening::lsa'
include_recipe 'windows-hardening::ntlm'
include_recipe 'windows-hardening::netlogon'
include_recipe 'windows-hardening::winlogon'